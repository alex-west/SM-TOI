;hijacks and value changes for Saveload
{
org $819A47		;Fix File Copy for the new SRAM files
	LDA.l SaveLoad_SRAMAddressTable,X : Skip 7 : LDA.l SaveLoad_SRAMAddressTable,X : Skip 11 : CPY #$0A00
org $819CAE		;Fix File Clear for the new SRAM files
	LDA.l SaveLoad_SRAMAddressTable,X : Skip 12 : CPY #$0A00
	
org $818000
	JMP SaveLoad_SaveGame
org $818085
	JMP SaveLoad_LoadGame
;i forget what all these commented out things are but the patch seems to work without them.
;org $818000
;    JMP $EF2D
;org $818085
;    JMP $EFDF
