...
;	Bugfix update 3-23-22: line 217 (was 215), DL SOUNDFX -> DW SOUNDFX.
;	No other changes have been made to this file since her original upload.
...
org $84E0D8			;Missile
	...
	DB !Missile	;Run the "click" sound
...
org $84E2C3			;Varia Suit
	DW SOUNDFX
	DB !Click	;I put no sound here because it plays after the message box
...
org $84F016			;You can safely change this address to free space in bank $84 ($20000-$27FFF)
CLIPCHECK:
	LDA $05D7
	CMP #$0002
	BEQ $0E
