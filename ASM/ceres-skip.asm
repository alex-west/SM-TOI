;Skipping Ceres, version 2.2 by Black Falcon
...
org $8BA592									;this part skips the white text at the very beginning
	...
	LDA #$A66F : STA $1F51					;(previously #$A5A7) starts loading green text and intro music
...
STUFF:
;	LDA #$0001 : LDX #$000C : JSR $8081A6	;Sets Boss bit in Ceres (Ridley escaped)
	LDA #$0000 : STA $7ED914				;set game state mirror to #$0000 (Prevents ship from initialising landing sequence)
	LDA #$001F : STA $0998					;start new game
	STZ $0723 : STZ $0725
